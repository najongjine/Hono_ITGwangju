const rawOpenApiSpec = {
    ...
    info: {
        ...
        version: "1.0.0",
        description: "Production local-file API and development Cloudinary uploads. Images are converted to WebP before storage.",
    },
    servers: [
        {
    ...
    paths: {
        ...
        "/api/user/admin/password-reset": {
            post: {
                ...
                description: "Admin-only endpoint. Finds a user by id, username/loginId, or email. If a new password is omitted, a temporary password is generated and returned.",
                security: [{ bearerAuth: [] }],
                requestBody: {
                    required: true,
                    content: {
                            ...
                            schema: {
                                ...
                                properties: {
                                    ...
                                    descriptionImageOrders: {
                                        type: "array",
                                        items: { type: "integer" },
                                        description: "Sort order values for descriptionImages. Also accepted as imageOrders or sortOrders. Falls back to upload order.",
                                        example: [0, 1, 2],
                                    },
                                },
                            },
...
export const openApiSpec = {
    ...rawOpenApiSpec,
    paths: Object.fromEntries(Object.entries(rawOpenApiSpec.paths).filter(([route]) => !route.startsWith("/api/supabase-test"))),
};
